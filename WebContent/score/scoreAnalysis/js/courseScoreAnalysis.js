...
define(function(require, exports, module) {
	...
	var courseScoreAnalysis = {
			...
			init : function() {
				...
				var courseInfo = new select({
					...
					onclick : courseScoreAnalysis.initTeachingClass
				}).init();
			...
			getPageList:function(){
				//获取查询参数
				var requestParam = utils.getQueryParamsByFormId("queryForm");
				courseScoreAnalysis.pagination = new pagination({
						id: "pagination", 
	...
	module.exports = courseScoreAnalysis;
    window.courseScoreAnalysis = courseScoreAnalysis;
