...
define(function(require, exports, module) {
	 ...
	 * 环节成绩分制
	 */
	var administrativeClassScoreAnalysis = {
			// 初始化
			init : function() {
				// 加载当前学年学期
				...
				var courseInfo = new select({
					...
					onclick : administrativeClassScoreAnalysis.initTeachingClass
				}).init();
				...
				$("#departmentId").change(function(){
					...
					administrativeClassScoreAnalysis.getData();
				...
				$("#courseDiv").change(function() {
					administrativeClassScoreAnalysis.initTeachingClass(courseInfo.getValue());
				});
				simpleSelect.loadEnumSelect("scoreType",scoreCategory,{defaultValue:scoreCategory.TotalScore.value});
				//查询
				$("#query").click(function(){
					administrativeClassScoreAnalysis.getPageList();
				});
				administrativeClassScoreAnalysis.getPageList();
				//绑定导出
			...
			getPageList:function(){
				//获取查询参数
				var requestParam = utils.getQueryParamsByFormId("queryForm");
				administrativeClassScoreAnalysis.pagination = new pagination({
						id: "pagination", 
	...
	module.exports = administrativeClassScoreAnalysis;
    window.administrativeClassScoreAnalysis = administrativeClassScoreAnalysis;
