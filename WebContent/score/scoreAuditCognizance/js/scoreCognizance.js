...
define(function(require, exports, module) {
    ...
    var scoreCognizance = {
        ...
        init : function() {
		    	...
		    	popup.askPop('确定审核通过已选记录？',function(){
				    ...
				    ajaxData.request(urlScore.SCORE_APPROVAL,JSON.stringify(list),function(data){
				    	if(data.code==config.RSP_SUCCESS){
				    		...
				    		scoreCognizance.pagination.loadData();
						}
						else{
            ...
            $(document).on("click", "[name='audit']", function() {
            	scoreCognizance.audit(this);
            });
            // 成绩审核-修改
            $(document).on("click", "[name='modify']", function() {
            	scoreCognizance.modify(this);
            });
            
            //加载数据
            scoreCognizance.getPagedList();
            ...
            $("#query").click(function(){
				...
				//保存查询条件
				scoreCognizance.pagination.setParam(requestParam);
            });
		...
		getPagedList:function(){
			...
			scoreCognizance.pagination = new pagination({
				id: "pagination", 
    ...
    module.exports = scoreCognizance;
    window.scoreAudit = scoreCognizance;
});