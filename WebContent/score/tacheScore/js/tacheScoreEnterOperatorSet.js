...
define(function(require, exports, module) {
    ...
    /*    getData:function(){
        ...
        setAll: function(){
           ...
           var mydialog = popup.open('./score/tacheScore/html/tacheScoreEnterOperatorBatchSet.html', // 这里是页面的路径地址
                {
                    id : 'setAll',// 唯一标识
                    title : '教师选择',// 这是标题
        ...
        set: function(obj){
            ...
            var mydialog = art.dialog.open('./score/tacheScore/html/tacheScoreEnterOperatorSingleSet.html', // 这里是页面的路径地址
                {
                    id : 'set',// 唯一标识
                    title : '教师选择',// 这是标题
                    width : 900,// 这是弹窗宽度。其实可以不写
